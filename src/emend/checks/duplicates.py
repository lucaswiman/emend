"""DuplicateCodeConfig wrapper: delegates to duplicate.py.

Extracted from lint.py's DuplicateCodeConfig, _parse_duplicate_code_config,
and _check_duplicate_code.
"""
...
def parse_duplicate_code_config(
    raw: object,
    *,
    rule_name: str = "duplicate-code",
...
def run_duplicate_code_check(
    ...
    Returns violation dicts with rule_name, message, file_path, line keys.
    """
